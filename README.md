...
<details><summary>01 Time</summary>
 ...
 Backlog no Trello - Utilizado para viabilizar o nosso roadmap (linkar as tarefas criadas a cada uma das ideias de criação de artefatos). Veja nosso <a href="https://trello.com/b/OEbo1AKb/kanban">Backlog no Trello</a> é necessário ser convidado para visualizar.

  </p>
  
<p>
  
  <b>Repositório e site de arquitetura de Design</b> - Utilizado para listar atividades relacionadas ao design. Seu acesso pode ser de dois modos:
